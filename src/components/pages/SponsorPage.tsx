...
import { Microphone, MoneyAdd } from 'iconsax-react';
...
const SponsorPage = () => {
    ...
    return (
        <div className=''>
            ...
            <section className="bg-[#CCF6C5]/90 [#ccf6c5] bg[#f8d8d9] [#fcf4f4] [#f0f0f0]  [#f8d8d9] h-[72vh] m-4 md:m-10 rounded-4xl relative ">
                ...
                <div className='relative grid place-items-center-safe h-full '>
                    ...
                    <div className="mt-28">
                        <h1 className="text-4xl md:text-6xl leading-14 text-center font-bold mb-4 sm:mb-6 text-[#1e1e1e]"
                            style={{
                        ...
                        <p className="text-base sm:text-lg px-6 md:text-xl text-[#1e1e1e] text-center mt-10 max-w-xl mx-auto">
                            Join DevFest Abeokuta 2025 and be part of the most exciting tech event in the region
                        </p>

                        <CustomButton
                            // href="#schedule"
                            href="https://docs.google.com/forms/d/e/1FAIpQLSechcUtAOXfjxoldUyELqSQmwxMvuiiJ0KHxTtChs2CPPrA3A/viewform"
                            label="Sponsor Us"
                            icon={<MoneyAdd size="25" color="#FF8A65"/>}
                            // clor="#EA4335"
